...
| **Hard Rule 3 — pins hard-expire on the day their author set, ≤ a year**      | Same safety analysis (§5.6): expiring, fuzzy pins are the report's cited best-practice alignment. The ceiling was 72h until 2026-09-10; the safety basis is unchanged.                                                                                                                                                 |

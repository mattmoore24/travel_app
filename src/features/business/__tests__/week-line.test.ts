...
describe('the How it is going line', () => {
  ...
  it('gives a brand new listing something to do rather than a zero', () => {
    ...
    expect(line).toBe(
      'Nobody has written this week. A listing with photos and hours gets read more.'
    );
    // Not "0 travelers wrote to you", which is the same fact said as a
